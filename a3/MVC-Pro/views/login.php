...
<form id="registration_form" action="http://corsair.cs.iupui.edu:21851/a3/login/do_login" method="post">
<fieldset>
<legend>Login</legend>
<label for = "username"><?php echo "Username:";?></label>
<input type="text" class="txt" id="username" name="username" value="" maxlength="50" required="username" />
<br />
